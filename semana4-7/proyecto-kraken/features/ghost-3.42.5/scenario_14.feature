Feature: Publish Post
  ...
  @user1 @web
  Scenario: As an admin user I delete a tag
    ...
    Then I enter "Test tag" into input field having xpath "/html/body/div[2]/div/main/section/form/div/div[1]/div[1]/div[1]/div[1]/input"
    Then I click on element having xpath "/html/body/div[2]/div/main/section/form/header/section/button/span"
    Then I click on element having xpath "/html/body/div[2]/div/nav[1]/section/div[1]/ul[2]/li[4]/a"
    Then I click on element having xpath "/html/body/div[2]/div/main/section/section/ol/li[3]/a"
    Then I click on element having xpath "/html/body/div[2]/div/main/section/button/span"
    Then I click on element having xpath "/html/body/div[4]/div/div/div/div/div[2]/section/div[2]/button[2]/span"
