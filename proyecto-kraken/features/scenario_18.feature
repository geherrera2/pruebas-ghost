Feature: General Settings - Edit Menu

  @user1 @web
  Scenario: As an admin user I edit the title in General Settings
    ...
    Then I click on element having xpath "/html/body/div[4]/div[1]/div/div/div/div/div[1]/div/div[1]/div[2]/form/div[5]/div/div/div/div[1]"
